                    ...
                    <div class="single-service">
                        <div class="media">
                            <div class="service-icon">
                                <span></span>
                                <img src="{{asset ('assets/img/services/service-icon-1.png') }}" alt="JSOFT">
                            </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-service">
                        <div class="media">
                            <div class="service-icon">
                                <span></span>
                                <img src="{{asset ('assets/img/services/service-icon-2.png') }}" alt="JSOFT">
                            </div>
                            <div class="media-body">
                                <h4>CAR REPAIR</h4>
                                <p>You can be a celebrity for a full night and half days with a nice one of our amazing Limousines, Hummers.</p>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-service">
                        <div class="media">
                            <div class="service-icon">
                                <span></span>
                                <img src="{{asset ('assets/img/services/service-icon-3.png') }}" alt="JSOFT">
                            </div>
                            <div class="media-body">
                                <h4>TAXI SERVICE</h4>
                                <p>You can be a celebrity for a full night and half days with a nice one of our amazing Limousines, Hummers.</p>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-service">
                        <div class="media">
                            <div class="service-icon">
                                <span></span>
                                <img src="{{asset ('assets/img/services/service-icon-4.png') }}" alt="JSOFT">
                            </div>
                            <div class="media-body">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-service">
                        <div class="media">
                            <div class="service-icon">
                                <span></span>
                                <img src="{{asset ('assets/img/services/service-icon-5.png') }}" alt="JSOFT">
                            </div>
                            <div class="media-body">
                                <h4>car wash</h4>
                                <p>You can be a celebrity for a full night and half days with a nice one of our amazing Limousines, Hummers.</p>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-service">
                        <div class="media">
                            <div class="service-icon">
                                <span></span>
                                <img src="{{asset ('assets/img/services/service-icon-6.png') }}" alt="JSOFT">
                            </div>
                            <div class="media-body">
                                <h4>call driver</h4>
                                <p>You can be a celebrity for a full night and half days with a nice one of our amazing Limousines, Hummers.</p>
                                                ...
                                                <div class="display-table">
                                                    <div class="display-table-cell">
                                                        <div class="ourcar-pic">
                                                            <img src="{{asset ('assets/img/car/car-5.jpg') }}" alt="JSOFT">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-8 text-center">
                                                <div class="display-table">
                                                    <div class="display-table-cell">
                                                        <div class="ourcar-pic">
                                                            <img src="{{asset ('assets/img/car/car-1.jpg') }}" alt="JSOFT">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-8 text-center">
                                                <div class="display-table">
                                                    <div class="display-table-cell">
                                                        <div class="ourcar-pic">
                                                            <img src="{{asset ('assets/img/car/car-2.jpg') }}" alt="JSOFT">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-8 text-center">
                                                <div class="display-table">
                                                    <div class="display-table-cell">
                                                        <div class="ourcar-pic">
                                                            <img src="{{asset ('assets/img/car/car-3.jpg') }}" alt="JSOFT">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-8 text-center">
                                                <div class="display-table">
                                                    <div class="display-table-cell">
                                                        <div class="ourcar-pic">
                                                            <img src="{{asset ('assets/img/car/car-4.jpg') }}" alt="JSOFT">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-5">
                                <div class="article-thumb">
                                    <img src="{{asset ('assets/img/article/arti-thumb-1.jpg') }}" alt="JSOFT">
                                </div>
                            </div>
                    ...
                    <article class="single-article middle">
                        <div class="row">
                            ...
                            <div class="col-lg-5 d-xl-none">
                                <div class="article-thumb">
                                    <img src="{{asset ('assets/img/article/arti-thumb-2.jpg') }}" alt="JSOFT">
                                </div>
                            </div>
                            <!-- Articles Thumbnail End -->
                ...
                <div class="col-lg-12">
                    <article class="single-article">
                        <div class="row">
                            ...
                            <div class="col-lg-5">
                                <div class="article-thumb">
                                    <img src="{{asset ('assets/img/article/arti-thumb-3.jpg') }}" alt="JSOFT">
                                </div>
                            </div>
                            <!-- Articles Thumbnail End -->
