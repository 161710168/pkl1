						...
						<div class="header_content d-flex flex-row align-items-center justify-content-start">
							...
							<nav class="main_nav_contaner ml-auto">
								<ul class="main_nav">
									...
									<li class="active"><a href="/berita">news</a></li>
			...
			<div class="row">
				...
				<div class="col-lg-8">
					<div class="news_posts">
						...
						<!-- News Post -->
						<div class="news_post">
							<div class="news_post_image"><img src="images/as_leather_accessories-20180905-0005.jpg" alt=""></div>
						...
						<!-- News Post -->
						<div class="news_post">
							<div class="news_post_image"><img src="images/as_leather_accessories-20180905-0014.jpg" alt=""></div>
							<div class="news_post_body">
								<div class="news_post_date"><a href="#">April 02, 2018</a></div>
						...
						<!-- News Post -->
						<div class="news_post">
							<div class="news_post_image"><img src="images/as_leather_accessories-20180905-0001.jpg" alt=""></div>
							<div class="news_post_body">
								<div class="news_post_date"><a href="#">April 02, 2018</a></div>
